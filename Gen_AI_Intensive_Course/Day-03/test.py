...
class Waiter:
    ...
    def order_node(self, state: OrderState) -> OrderState:  # Removed @staticmethod
        ...
        print(f"State before update in order_node: {state}")  # Log the original state
        print(f"Outbound messages: {outbound_msgs}")
        print(f"Order: {order}, Finished: {order_placed}")
